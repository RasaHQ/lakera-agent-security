...
class MockFinancingAPI:
    ...
    def calculate_loan_details(
        ...
        """
        Calculates loan details, including monthly payment, total interest.
        ...
        Returns:
            str: A JSON string with financing estimates, or an error.
        """
        print(
...
if __name__ == "__main__":
    ...
    result1 = financing_api.calculate_loan_details(
        purchase_amount=28000.0, loan_term_months=60
    )
    ...
    result5 = financing_api.calculate_loan_details(
        purchase_amount=28000.0, loan_term_months=99
    )
    print("\n--- Test 5: Invalid Loan Term ---")
